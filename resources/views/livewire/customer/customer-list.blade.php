                            ...
                            <div class="col">
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk">
                                        <div class="add-group">
                                            <a wire:click="createCustomer" class="btn btn-primary ms-2"><img src="{{ asset('assets/img/icons/plus.svg') }}" alt>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <button type="button" class="btn btn-primary btn-sm mx-1" wire:click="editCustomer({{ $customer->id }})" title="Edit">
                                                <i class='fa fa-pen-to-square'></i>
                                            </button>
                                            <a class="btn btn-danger btn-sm mx-1" wire:click="deleteCustomer({{ $customer->id }})" title="Delete">
