			...
			<div class="col-sm-12">
				<div class="card card-table show-entire">
					<div class="card-body">
						...
						<form action="{{ route('service.save', $service_key->id) }}" method="post">
							@csrf
								...
								<table class="table border-0 custom-table comman-table mb-0">
									...
									<tbody>
										...
										@foreach ($service_results as $result)
											<tr>
												<td>{{ $result->name }}</td>
												<td><input class="form-control" name="result[{{ $i }}]" type="text"
														@if ($xray == true) @if ($result->name == 'Type of View') value="Chest PA View" @endif
														@endif>
												</td>
